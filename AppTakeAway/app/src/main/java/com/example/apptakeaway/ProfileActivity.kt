...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        passwordTextView.text = "Contraseña: [No se muestra por motivos de seguridad]"
        ...
        lifecycleScope.launch {
            try {
                ...
                if (response.isSuccessful) {
                    Toast.makeText(this@ProfileActivity, "Usuario actualizado con éxito.", Toast.LENGTH_SHORT).show()
                } else {
                    Toast.makeText(this@ProfileActivity, "Error al actualizar el perfil.", Toast.LENGTH_SHORT).show()
                }
            } catch (e: Exception) {
                Toast.makeText(this@ProfileActivity, "Error: ${e.message}", Toast.LENGTH_SHORT).show()
                Log.d("ProfileActivity", "Error al actualizar el perfil: ${e.message}", e)
            }
        }
    }
